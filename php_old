...
syn match phpDollar "\$"  contained display
...
if exists("php_parent_error_open")
  syn region  phpComment  start="/\*" end="\*/" contained contains=phpTodo,phpDocBlock
else
  syn region  phpComment  start="/\*" end="\*/" contained contains=phpTodo,phpDocBlock extend
endif
if version >= 600
